...
VALUES
('Qual é a capital do Brasil?', 'São Paulo', 'Rio de Janeiro', 'Brasília', 'Salvador', 'C', 'FACIL'),
...
('Em que ano o homem pisou na Lua?', '1959', '1969', '1979', '1989', 'B', 'MEDIO'),
('Qual elemento químico tem o símbolo Fe?', 'Ferro', 'Flúor', 'Fósforo', 'Fênix', 'A', 'DIFICIL');
...
SELECT enunciado, alternativaA, alternativaB, alternativaC, alternativaD
FROM pergunta
WHERE nivelDificuldade = 'DIFICIL';

SELECT enunciado, correta FROM pergunta;
